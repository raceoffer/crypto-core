...
import * as proto from './distributedsyncsession.json';

const root = Root.fromJSON(proto);

export const EcdsaInitialCommitment = generateMessage(
...
export const EcdsaInitialDecommitment = generateMessage(
...
export const EcdsaResponseCommitment = generateMessage(
...
export const EcdsaResponseDecommitment = generateMessage(
...
export const EcdsaSyncData = generateMessage(
  'EcdsaSyncData', {
    publicPoint: [Field.Point]
  },
  root
...
export class DistributedEcdsaSyncSession extends generateMessage(
...
export const EcdsaInitialData = generateMessage(
  'EcdsaInitialData', {
    pedersenParameters: [Field.Point],
    publicPoint: [Field.Point],
...
export const EcdsaChallengeCommitment = generateMessage(
...
export const EcdsaChallengeDecommitment = generateMessage(
...
export const EcdsaShardSyncData = generateMessage(
  'EcdsaShardSyncData', {
    publicPoint: [Field.Point],
    paillierPublicKey: [Field.Custom, PaillierPublicKey],
...
export class DistributedEcdsaSyncSessionShard extends generateMessage(
