...
export class InitialCommitment {
  ...
  toBytes() {
    const type = root.lookupType('InitialCommitment');
  ...
  static fromBytes(bytes) {
    return new InitialCommitment().fromBytes(bytes);
  }
}
...
export class InitialDecommitment {
  ...
  toBytes() {
    const type = root.lookupType('InitialDecommitment');
    return new Buffer(type.encode(this.toJSON()).finish());
  }
  ...
  static fromBytes(bytes) {
    return new InitialDecommitment().fromBytes(bytes);
  }
}
...
export class ResponseCommitment {
  ...
  toBytes() {
    const type = root.lookupType('ResponseCommitment');
    return new Buffer(type.encode(this.toJSON()).finish());
  }
  ...
  static fromBytes(bytes) {
    return new ResponseCommitment().fromBytes(bytes);
  }
}
...
export class ResponseDecommitment {
  ...
  toBytes() {
    const type = root.lookupType('ResponseDecommitment');
    return new Buffer(type.encode(this.toJSON()).finish());
  }
  ...
  static fromBytes(bytes) {
    return new ResponseDecommitment().fromBytes(bytes);
  }
}

export class ProverSyncData {
  constructor() {
    this.curve = null;
    this.crypto = null;
  ...
  static fromOptions(options) {
    return new ProverSyncData().fromOptions(options);
  }
  ...
  static fromJSON(json, hex) {
    return new ProverSyncData().fromJSON(json, hex);
  }

  toBytes() {
    const type = root.lookupType('ProverSyncData');
    return new Buffer(type.encode(this.toJSON()).finish());
  }
  ...
  static fromBytes(bytes) {
    return new ProverSyncData().fromBytes(bytes);
  }
}
...
export class PaillierProver {
  ...
  toJSON(hex) {
    return {
      ...
      remotePedersenParameters: encodePoint(this.remotePedersenParameters, hex),
  ...
  fromJSON(json, hex) {
    ...
    this.remotePedersenParameters = decodePoint(this.crypto, json.remotePedersenParameters, hex);
  ...
  toBytes() {
    const type = root.lookupType('PaillierProver');
    return new Buffer(type.encode(this.toJSON()).finish());
  }
  ...
  processChallengeCommitment(remote) {
    console.log(this.localPaillierSecretKey, remote.challenge);
    ...
    console.log(this.alpha, response);
