...
export class InitialDecommitment {
  ...
  fromJSON(json, hex) {
    ...
    this.paillierPublicKey = fromJSON(PaillierPublicKey, options.paillierPublicKey, hex);
    this.publicPoint = decodePoint(this.crypto, options.publicPoint, hex);
    this.chiphertext = decodeBigInteger(options.chiphertext, hex);
    this.initialDecommitment = decodeBN(options.initialDecommitment, hex);
...
export class ResponseCommitment {
  ...
  fromJSON(json, hex) {
    ...
    this.responseCommitment = decodePoint(this.crypto, options.responseCommitment, hex);
...
export class ResponseDecommitment {
  ...
  fromJSON(json, hex) {
    ...
    this.responseDecommitment = decodeBN(options.responseDecommitment, hex);
    this.response = decodePoint(this.crypto, options.response, hex);
...
export class PaillierProver {
  ...
  createInitialCommitment() {
    ...
    const [ initialCommitment, initialDecommitment ] = this.localPedersenScheme.commit(message);

    this.localInitialDecommitment = initialDecommitment;
  ...
  processChallengeCommitment(remote) {
    ...
    const [ responseCommitment, responseDecommitment ] = this.localPedersenScheme.commit(message);

    this.localResponseDecommitment = responseDecommitment;
  ...
  processChallengeDecommitment(remote) {
    ...
    return ResponseDecommitment.fromOptions({
