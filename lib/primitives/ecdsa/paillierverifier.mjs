...
export class ChallengeDecommitment {
  ...
  fromJSON(json, hex) {
    ...
    this.revealDecommitment = decoedBN(json.revealDecommitment, hex);
    this.a = decoedBN(json.a, hex);
    this.b = decoedBN(json.b, hex);
...
export class SyncData {
  ...
  static fromJSON(json, hex) {
    return new SyncData().fromJSON(json, hex);
  }
}
...
export class PaillierVerifier {
  ...
  toJSON(hex) {
    return {
      ...
      a: encodeBN(this.a, hex),
      b: encodeBN(this.b, hex),
      remotePublicPoint: encodePoint(remotePublicPoint, hex),
  ...
  processInitialDecommitment(remote) {
    ...
    const [ revealCommitment, revealDecommitment ] = this.localPedersenScheme.commit(Buffer.from(JSON.stringify({
      a: encodeBN(this.a, true),
      b: encodeBN(this.b, true)
    }), 'ascii'));

    this.localRevealDecommitment = revealDecommitment;
