...
export class InitialData {
  ...
  toBytes() {
    const type = root.lookupType('InitialData');
  ...
  static fromBytes(bytes) {
    return new InitialData().fromBytes(bytes);
  }
}
...
export class ChallengeCommitment {
  ...
  toBytes() {
    const type = root.lookupType('ChallengeCommitment');
    return new Buffer(type.encode(this.toJSON()).finish());
  }
  ...
  static fromBytes(bytes) {
    return new ChallengeCommitment().fromBytes(bytes);
  }
}
...
export class ChallengeDecommitment {
  ...
  toBytes() {
    const type = root.lookupType('ChallengeDecommitment');
    return new Buffer(type.encode(this.toJSON()).finish());
  }
  ...
  static fromBytes(bytes) {
    return new ChallengeDecommitment().fromBytes(bytes);
  }
}
...
export class VerifierSyncData {
  ...
  toBytes() {
    const type = root.lookupType('VerifierSyncData');
    return new Buffer(type.encode(this.toJSON()).finish());
  }
  ...
  static fromBytes(bytes) {
    return new VerifierSyncData().fromBytes(bytes);
  }
}
...
export class PaillierVerifier {
  ...
  toBytes() {
    const type = root.lookupType('PaillierVerifier');
    return new Buffer(type.encode(this.toJSON()).finish());
  }
