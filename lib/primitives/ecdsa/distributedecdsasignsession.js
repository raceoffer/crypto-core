...
const proto = require('./distributedecdsasignsession.json');

const root = Root.fromJSON(proto);

const EcdsaEntropyCommitment = generateMessage(
...
const EcdsaEntropyDecommitment = generateMessage(
...
const EcdsaEntropyData = generateMessage(
  'EcdsaEntropyData', {
    publicEntropy: [Field.Point],
    schnorrProof: [Field.Custom, SchnorrProof]
  },
...
const EcdsaPartialSignature = generateMessage(
...
const EcdsaSignature = generateMessage(
  'EcdsaSignature', {
...
class DistributedEcdsaSignSession extends generateMessage(
...
class DistributedEcdsaSignSessionShard extends generateMessage(
