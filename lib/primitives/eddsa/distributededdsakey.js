...
const { EddsaKeyPair } = require('./eddsakeypair');
...
} = require('./distributededdsasyncsession');

const {
  DistributedEddsaSignSession,
  DistributedEddsaSignSessionShard
} = require('./distributededdsasignsession');

const { Root } = require('protobufjs');
const proto = require('./distributededdsakey.json');
