...
const { EddsaKeyPair } = require('./primitives/eddsa/eddsakeypair');
...
const {
  DistributedEddsaKey
} = require("./primitives/eddsa/distributededdsakey");
...
const {
  ...
  EcdsaSyncData,
  EcdsaShardSyncData
} = require('./primitives/ecdsa/distributedecdsasyncsession');
...
const {
  ...
  EddsaData,
  EddsaSyncData
} = require('./primitives/eddsa/distributededdsasyncsession');
...
const {
  ...
  EddsaSignature
} = require('./primitives/eddsa/distributededdsasignsession');
