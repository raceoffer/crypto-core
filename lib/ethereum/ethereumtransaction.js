...
EthereumTransaction.prototype.startSign = function(hashes, keyMap) {
  this.signers = keyMap.startSign(hashes);
};

EthereumTransaction.prototype.createEntropyCommitments = function() {
  return this.signers.createEntropyCommitment();
};

EthereumTransaction.prototype.processEntropyCommitments = function(commitments) {
  return this.signers.processEntropyCommitment(commitments);
};

EthereumTransaction.prototype.processEntropyDecommitments = function(decommitments) {
  this.signers.processEntropyDecommitment(decommitments);
};

EthereumTransaction.prototype.computeCiphertexts = function() {
  return this.signers.computeCiphertext();
};

EthereumTransaction.prototype.extractSignatures = function(ciphertexts) {
  return this.signers.extractSignature(ciphertexts);
};
