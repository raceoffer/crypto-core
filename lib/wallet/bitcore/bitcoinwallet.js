...
BitcoinWallet.prototype.createTransaction = async function(to, value, fee) {
  ...
  return BitcoinTransaction.fromOptions({
...
BitcoinWallet.prototype.transactionFromJSON = function(json) {
  return BitcoinTransaction.fromJSON(json);
};
