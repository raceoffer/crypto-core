...
import {EtherscanProvider} from "../../provider/etherscanprovider";
...
export class EthereumWallet {
  ...
  fromOptions(options) {
    ...
    this.etherscanProvider = EtherscanProvider.fromOptions({
      endpoint: this.network == EthereumWallet.Mainnet ? 'https://api.etherscan.io' : 'https://api-ropsten.etherscan.io',
  ...
  async getTransactions(from, to) {
    ...
    const txs = await this.etherscanProvider.getTransactions(this.address, offset, page);
