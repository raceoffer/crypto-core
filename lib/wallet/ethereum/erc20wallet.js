...
ERC20Wallet.prototype.fromInternal = function(value) {
  return parseFloat(unit.fromWei(value.div(new BN(10).mul(18 - this.decimals)), 'ether'));
};

ERC20Wallet.prototype.toInternal = function(value) {
  return unit.toWei(parseFloat(value).toFixed(18), 'ether').div(new BN(10).pow(18 - this.decimals));
};
