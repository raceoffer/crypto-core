...
ERC20Wallet.prototype.fromOptions = function(options) {
  ...
  let endpoint = null;
  switch (this.network) {
    case ERC20Wallet.Mainnet:
      endpoint = 'https://mainnet.infura.io';
      break;
    case ERC20Wallet.Testnet:
...
ERC20Wallet.prototype.createTransaction = async function(to, value, fee) {
  ...
  return EthereumTransaction.fromOptions(tx, true);
};

ERC20Wallet.prototype.transactionFromJSON = function(json) {
