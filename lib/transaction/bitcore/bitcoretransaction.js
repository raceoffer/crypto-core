...
} = require('../../primitives/ecdsa/distributedecdsakey');
...
const {
  ...
  EcdsaSignature
} = require('../../primitives/ecdsa/distributedecdsasignsession');

const { Root } = require('protobufjs');
const proto = require('./bitcoretransaction.json');
...
const BitcoreEntropyCommitment = generateMessage(
...
const BitcoreEntropyDecommitment = generateMessage(
...
const BitcoreSignature = generateMessage(
  'BitcoreSignature', {
...
class BitcoreSignSession extends generateMessage(
  'BitcoreSignSession', {
    mapping: [Field.Array, Field.Custom, DistributedEcdsaKey],
...
const BitcoreEntropyData = generateMessage(
  'BitcoreEntropyData', {
...
const BitcorePartialSignature = generateMessage(
...
class BitcoreSignSessionShard extends generateMessage(
