...
import {
  ...
  PartialSignature,
  Signature
} from '../../primitives/ecdsa/distributedsigner';
...
export const BitcoreEntropyCommitment = generateMessage(
  'BitcoreEntropyCommitment', {
    entropyCommitment: [Field.Array, Field.Custom, EntropyCommitment]
  },
  root
);
...
export const BitcoreEntropyDecommitment = generateMessage(
  'BitcoreEntropyDecommitment', {
    entropyDecommitment: [Field.Array, Field.Custom, EntropyDecommitment]
  },
  root
);
...
export const BitcoreSignature = generateMessage(
  'BitcoreSignature', {
    mapping: [Field.Array, Field.Custom, DistributedKey],
    signature: [Field.Array, Field.Custom, Signature]
  },
  root
);
...
export class BitcoreSignSession extends generateMessage(
  'BitcoreSignSession', {
    mapping: [Field.Array, Field.Custom, DistributedKey],
    signers: [Field.Array, Field.Custom, DistributedSigner]
  },
  root
) {
...
export const BitcoreEntropyData = generateMessage(
  'BitcoreEntropyData', {
    entropyData: [Field.Array, Field.Custom, EntropyData]
  },
  root
);
...
export const BitcorePartialSignature = generateMessage(
  'BitcorePartialSignature', {
    partialSignature: [Field.Array, Field.Custom, PartialSignature]
  },
  root
);
...
export class BitcoreSignSessionShard extends generateMessage(
  'BitcoreSignSessionShard', {
    mapping: [Field.Array, Field.Custom, DistributedKeyShard],
    signers: [Field.Array, Field.Custom, DistributedSignerShard]
  },
  root
) {
  static fromOptions(options) {
