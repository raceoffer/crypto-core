...
import { Signer as SignerEcdsa, PartialSignature as PartialSignatureEcdsa } from './primitives/ecdsa/distributedsigner';
import { Signer as SignerEddsa, PartialSignature as PartialSignatureEddsa, Signature } from './primitives/eddsa/signer';
